(function(m, t, A) {
    ...
    function Sb(a, b, c, d, f) {
                    ...
                    if (e[X])
                        ...
                        if (b) {
                            ...
                            for (var c = b.length, k = 0; k < c; k++)
                                /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[k].tagName) && !b[k][X] && u(b[k])
                        } else
                            u(e)
                    }
                else
        ...
        function E(a, e, b) {
            a = U.getTarget(a);
            var c = na(a);
            c.ignore || !c.forceRecord && (c.isPrivate && f.get("isEU") || ra(a)) || (u(a),
            ba(k, [x.nowEventTime(), e, b, a, c.privateFlag]))
        }
        function P(a) {
            var e = a.keyCode
              , b = sb(a);
        ...
        function fa(a) {
            Ha && !oa && 0 !== a.which && (E(a, a.charCode || a.keyCode, sb(a)),
            oa = !0,
            h.setTimeout(function() {
                oa = !1
            }, 1, "fvl.keyPress"))
        ...
        function ca() {
            if (m.getSelection) {
                ...
                t.selection && t.selection.createRange && (a = t.selection.createRange(),
                b = a.text,
                c = a.parentElement());
            if ("string" == typeof b) {
                try {
                ...
                if (a[X])
                    ...
                    if (e) {
                        ...
                        for (var b = e.length, c = 0; c < b; c++)
                            /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e[c].tagName) && !e[c][X] && u(e[c])
                    } else
                        u(a)
                }
        ...
        function K(a) {
            (a = U.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (u(a),
            ba(Ta, [x.nowEventTime(), a]))
        }
        function L(a) {
        ...
        if (!h.isMetrikaPlayer()) {
            ...
            if (v.getBody())
                w.on(t, "mouseleave", N);
            t.attachEvent && !m.opera ? (w.on(t, "focusin", D),
            w.on(t, "focusout", I)) : (w.on(m, "focus", Q),
            w.on(m, "blur", C),
            w.on(t, "blur", C));
            t.addEventListener ? (w.on(t, "focus", R),
            w.on(t, "blur", K),
            w.on(t, "change", L),
            w.on(t, "submit", J)) : t.attachEvent && (w.on(t, "focusin", R),
            w.on(t, "focusout", K),
            function() {
        ...
        return {
            ...
            stop: function() {
                ...
                w.un(m, "blur", C);
                w.un(t, "blur", C);
                t.removeEventListener ? (w.un(t, "focus", R),
                w.un(t, "blur", K),
                w.un(t, "change", L),
                w.un(t, "submit", J)) : t.detachEvent && (w.un(t, "focusin", R),
                w.un(t, "focusout", K),
                function() {
                    for (var a = t.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                        for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++)
                            /^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName) && w.un(b[c], "change", L);
                        w.un(a[e], "submit", J)
                    }
                }());
                (function() {
    ...
    function Wb(a) {
        var b = [], c = a._lastPerformanceTiming, d = wb(), f;
        if (c) {
            var l = 0;
        ...
        if (xb)
            ...
            , function(a, b, c) {
                ...
                Object(a.a)(r, function(a) {
                    ...
                    p[a] = y ? e ? (b = r[a]).bind.apply(b, [r].concat(F)) : r[a] : e ? function() {}
                    : r[a]
                }, !0);
                y && (p.devLog = r.log);
                b["default"] = p
            ...
            , function(a, b, c) {
                ...
                b.a = function() {
                    ...
                    if ("undefined" !== typeof t && t.body) {
                        ...
                        try {
                            /Trident|MSIE/.test(navigator.userAgent) ? t.body.parentNode && t.body.parentNode.appendChild(b) : t.body.appendChild(b),
                    ...
                    if (G(a, b, c)) {
                        k = e.reduce(function(e, c) {
                            try {
                                ...
                                return y["default"].warn("Filtering error", ca),
                                e
                            }
                        }, k);
                        if ("string" === typeof k)
                        ...
                        create: function(a, b) {
                            ...
                            g = {
                                ...
                                run: function(b) {
                                    ...
                                    if (!z) {
                                        k = b;
                                        for (var g = arguments.length, f = Array(1 < g ? g - 1 : 0), r = 1; r < g; r++)
                                            f[r - 1] = arguments[r];
                                        m = f;
                                        q && n ? (q = !1,
                                        B = b,
                    ...
                    b.a = function(b) {
                        ...
                        try {
                            if (b.forEach)
                                ...
                                for (var p = b[a.iterator](), h, q; h = p.next(),
                                q = h.value,
                                !h.done; )
                                    c.push(q);
                            return c
                        ...
                        a.mock = function() {
                            if (!this.mocked) {
                                ...
                                HTMLCanvasElement.prototype.getContext = function(b) {
                                    var c = h.call(this, b);
                                    if (null !== c)
                                        return !1 !== this.proxy && 0 <= y.indexOf(b) && a.update(c),
                                        c
                                }
                                ;
                        ...
                        c.mock = function() {
                            ...
                            p.IterableUtils.forof(F.methods, function(e) {
                                ...
                                Object.defineProperty(b, e, {
                                    configurable: !0,
                                    value: function() {
                                        for (var a, b = arguments.length, k = Array(b), f = 0; f < b; f++)
                                            k[f] = arguments[f];
                        ...
                        d.addToIndex = function(a, b, c) {
                            ...
                            if (a = this.middleware.run(a)) {
                                ...
                                if (!1 === this.dom.has(a) || null == e) {
                                    ...
                                    this.recorder && "INPUT" === d && (b = Z.a.validate(a, this.recorder.options),
                                    d = b.forceRecord,
                                    b = !b.isAllowed && !d,
            ...
            , function(a, b, c) {
                (function(a) {
                    ...
                    d = function() {
                        ...
                        var c = b.prototype;
                        c.send = function(a, b) {
                            var c = this, d = void 0 === b ? {} : b, k = d.data, f = d.onResponse, g = d.onTimeout, l = d.receiver, q = d.awaitResponse, n = d.timeoutTime, h = null, y = !1, p = !1, m, F = [], t = Date.now();
                            "function" === typeof f && (y = !0,
                            h = a + "." + this.timestamp,
                            this.listenOnce(function(a) {
                                var b = a.data
                                  ...
                                  , d = b.data;
                                if (b.type === h)
                                    e ? r["default"].warn("Seems like you forgot to call `answer` in a message handler. This message requires response.") : (p = !0,
                                    f(d, {
                                        origin: a.origin,
                    ...
                    d = Object.defineProperties({
                        ...
                        patchCSS: function(a, b) {
                            var c = this
                              ...
                              , d = void 0 === e ? null : e;
                            e = ["cssURLFinder", "URLImportFinder", "cssURLFinderNoParenthesis"];
                            var k = {
                        ...
                        patchURLS: function(a, b, c, e) {
                            ...
                            "string" === typeof a && a.match(b) && (k = a.replace(b, function() {
                                var a = d.patchURL(1 >= arguments.length ? A : arguments[1], {
                                    location: c
                                });
                                return g(a)
                            }));
                        ...
                        applyPatch: function(b, c) {
                            ...
                            if (h.test("dataurlTest", b) || h.test("selectorTest", b))
                                return b;
                            h.test("protocolMissing", b) && (d = h.test("protocolIncomplete", b) ? b.replace(h.get("protocolIncomplete"), g + "//") : g + "//" + (k + "/" + e).replace(/\/\/+/, "/"));
                            q.set(b, d);
                            /http[s]?/.test(d) ? (k = d,
                            h.test("proxiedURL", k) ? d = k : (p.isWhitelisted ? (g = p.isWhitelisted(k)) && a.warn("Whitelisted: " + k) : g = !1,
                            d = g ? k : (g = p.proxy) && h.test("resourceFinder", g) ? g.replace(h.get("resourceFinder"), encodeURIComponent(k)) : k),
                            H.push(d),
                            F.set(b, d),
                            k = d) : (H.push(b),
                            F.set(b, d),
                        ...
                        return {
                            create: function(a) {
                                a.keyCapture.onCapture(function(b) {
                                    "OBJECT" === t.activeElement.nodeName && /flash/.test(t.getAttribute("type")) || (b = a._getEventObject("keystroke", -1, b),
                                    a._publishActions(b))
                                })
                            },
                            destroy: function(a) {
                        ...
                        var a, b = function(a, b) {
                            var c = 0
                              , e = function() {
                                ...
                                d && (0 !== d.stamp ? this._publishActions(d) : 3 > c && (I(e, 300),
                                c += 1))
                            }
                            .bind(this);
                            e()
                ...
                (function(a, f, l) {
                    ...
                    var qa = function(b) {
                        ...
                        d.configure = function() {
                            ...
                            P.c.addAttributesFilter(function(b, c, e) {
                                if (G.a.isValidNode(b) && "value" === c)
                                    return b = G.a.validate(b, a),
                                    c = b.forceRecord,
                                    b.isAllowed || c ? e : G.a.encode(e);
                                if ("checked" === c && ["INPUT", "CHECKBOX", "RADIO"].includes(b.nodeName))
                        ...
                        d.__initEventHandlers = function() {
                            this.summary = new w.a(this.document.documentElement,this.indexer,this);
                                ...
                                var e = function fb(a) {
                                    ...
                                    if (c && e) {
                                        if (!0 === c.__YM_WV_RECORDABLE__)
                                            return Y["default"].warn("Iframe has internal counter installed");
                                        if (!0 === c.__YM_RECORDING__)
                                            return Y["default"].warn("We're already recording this iframe", a);
                                        ...
                                        return Y["default"].info("Recorder injected into the iframe", a)
                                    }
                                    I(function() {
                                        return fb(a)
                                    }, 10)
                                  ...
                                  , d = function(c) {
                                    b.errorLogger(function() {
                                        if (c && c.parentElement && c.contentDocument && V.DOMUtils.isBlankOrSameOriginIframe(a, b.window) && !0 !== c.contentWindow.__WV_ENABLED__)
                                            try {
                                                e(c)
                                            } catch (fb) {
                                                Y["default"].error(fb),
                                                Y["default"].warn("Probably this iframe is cross-origin")
                                            }
                                    }, "ifLo")
                                };
                        ...
                        d.stop = function(a, b) {
                            ...
                            void 0 === a && (a = !1);
                            void 0 === b && (b = !0);
                            S && !O && (!1 !== this.started && this.inited || a) && !0 !== this.stopped && (clearTimeout(this.cancelIfNotStarted),
            ...
            , function(a, b, c) {
                (function(b) {
                    var d = c(69), l = c(83), g = Object.create, h = Object.defineProperties, r = Object.defineProperty, y = Object.prototype, p, m = g(null);
                    if ("function" === typeof b) {
                        var q = b;
                        try {
                            String(q());
            ...
            , function(a, b, c) {
                (function(b) {
                    (function(b, c) {
                        ...
                        function u(b, c, e) {
                            c.constructor === b.constructor && e === q && c.constructor.resolve === k ? Z(b, c) : e === S ? (G(b, S.error),
                            S.error = null) : e === A ? x(b, c) : a(e) ? z(b, c, e) : x(b, c)
                        }
                        function v(a, b) {
                            if (a === b)
                        ...
                        function D(b, c, e, d) {
                            ...
                            if (k) {
                                ...
                                g = d,
                                l = !0;
                            c._state === Y && (k && l ? v(c, g) : B ? G(c, f) : b === R ? x(c, g) : b === U && G(c, g))
                        }
                        function K(a, b) {
                            try {
                                b(function(b) {
                        ...
                        var ha = Math.random().toString(36).substring(2)
                          ...
                          , ja = function() {
                            function a(a, b) {
                                ...
                                J(b) ? (this._remaining = this.length = b.length,
                                this._result = Array(this.length),
                                0 === this.length ? x(this.promise, this._result) : (this.length = this.length || 0,
                                this._enumerate(b),
                                0 === this._remaining && x(this.promise, this._result))) : G(this.promise, Error("Array Methods must be provided an Array"))
                            }
                            ...
                            a.prototype._eachEntry = function(a, b) {
                                var c = this._instanceConstructor
                                  , d = c.resolve;
                                d === k ? (d = B(a),
                                d === q && a._state !== Y ? this._settledAt(a._state, b, a._result) : "function" !== typeof d ? (this._remaining--,
                                this._result[b] = a) : c === O ? (c = new c(e),
                                u(c, a, d),
            ...
            , function(a, b, c) {
                (function(b, c) {
                    !function(d) {
                        ...
                        var u = Object.prototype, v = u.hasOwnProperty, w, x = "function" === typeof b ? b : {}, A = x.iterator || "@@iterator", E = x.asyncIterator || "@@asyncIterator", C = x.toStringTag || "@@toStringTag";
                        x = "object" === typeof a;
                        ...
                        if (D)
                            ...
                            ;
                            (x = (x = Object.getPrototypeOf) && x(x(Z([])))) && x !== u && v.call(x, A) && (d = x);
                            ...
                            z.prototype = {
                                ...
                                reset: function(a) {
                                    ...
                                    if (!a)
                                        for (var b in this)
                                            "t" === b.charAt(0) && v.call(this, b) && !isNaN(+b.slice(1)) && (this[b] = w)
                                },
                                stop: function() {
                                    this.done = !0;
    ...
    var w = J.inherit({
        ...
        on: function(a, b, c, d, f) {
            f = w._getOpts(f);
            b = b.split(",");
            var l = b.length, g = this._listeners, h;
            for (h = 0; h < l; h++) {
                var r = b[h];
                var y = D(function(a) {
    ...
    var ac = Ba.inherit({
        ...
        index: 1,
        request: function(a, b, c, d) {
            "function" === typeof navigator.sendBeacon && !u.isAndroidWebView() && navigator.onLine ? (b = this._splitParams(b),
            b.get["force-urlencoded"] = 1,
            c.call(d, navigator.sendBeacon(this._buildUrl(a, b.get), wa.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    var S = J.inherit({
        ...
        getStorageId: function() {
            var a = this.get("lsid");
            a || (a = Math.round(Math.random() * x.getMs()),
            this.set("lsid", a));
            return a
        },
    ...
    h.hiddenFrameCreate = function(a, b) {
        ...
        if (c = h._hiddenFrames[a])
            return -1 === h.arrayIndexOf(c.owners, b) && c.owners.push(b),
    ...
    h.hiddenFrameRemove = function(a, b) {
        var c = h._hiddenFrames[a], d;
        c && -1 !== h.arrayIndexOf(c.owners, b) && (c.owners = h.filter(function(a) {
            return a !== b
        }, c.owners),
        c.owners.length || ((d = c.frame.parentNode) && d.removeChild(c.frame),
    ...
    var ja = {
        ...
        tailSafe: "*-_",
        encode: function(a, b) {
            var c = (ja.abc + (b ? ja.tailSafe : ja.tail)).split(""), d = a.length, f = [], l = d - d % 3, g;
            for (g = 0; g < l; g += 3) {
        ...
        decode: function(a, b) {
            for (var c = ja.abc + (b ? ja.tailSafe : ja.tail), d = 0, f = "", l, g, h, r, y; a.length % 4; )
                a += "\x3d";
            do {
    ...
    u.isSameSite = h.memorize(function() {
        var a = /Chrome\/(\d+)\./;
        return m.navigator && navigator.userAgent && (a = navigator.userAgent.match(a)) && 1 < a.length ? (a = parseInt(a[1], 10),
        76 <= a) : !1
    });
    var N = J.inherit({
        counterId: "",
        ...
        create: function(a, b, c) {
            ...
            if (this.isAllowed(a)) {
                ...
                this.sameSiteStr && "https:" === m.location.protocol && (b.push(this.sameSiteStr),
                b.push("Secure"));
    ...
    W.retransmit = function(a) {
        var b = W._storage, c = b.get("retryReqs") || {}, d;
        b.remove("retryReqs");
        h.forEachKey(c, function(b, c) {
            var g = x.getMs();
            a.get("firstReqStatus") || a.set("firstReqStatus", "complete");
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 1728E5 > g && 500 < g - c.time && 2 >= c.browserInfo.rqnl && (d = new W({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    var v = {}
      , fc = h.memorize(function() {
        var a = {}, b = 59, c = String.fromCharCode, d, f = "A B BIG BODY BUTTON DD DIV DL DT EM FIELDSET FORM H1 H2 H3 H4 H5 H6 HR I IMG INPUT LI OL P PRE SELECT SMALL SPAN STRONG SUB SUP TABLE TBODY TD TEXTAREA TFOOT TH THEAD TR U UL ABBR AREA BLOCKQUOTE CAPTION CENTER CITE CODE CANVAS DFN EMBED FONT INS KBD LEGEND LABEL MAP OBJECT Q S SAMP STRIKE TT ARTICLE AUDIO ASIDE FOOTER HEADER MENU METER NAV PROGRESS SECTION TIME VIDEO NOINDEX NOBR MAIN svg circle clippath ellipse defs foreignobject g glyph glyphref image line lineargradient marker mask path pattern polygon polyline radialgradient rect set text textpath title".split(" ");
    ...
    ;
    v.getBody = function() {
        for (var a = t.getElementsByTagName("body"); 0 < a.length; )
            return a[0]
    }
    ;
    ...
    var zb = {
        ...
        _send: function() {
            ...
            w.ready(function() {
                ...
                u.isSafari() && (b.style.position = "absolute",
    ...
    var gc = h.memorize(function() {
        if (!m.yandex || !m.yandex.getSiteUid)
            return "";
        if (h.isFunction(m.yandex.getSiteUid))
            return m.yandex.getSiteUid()
    })
      , Ra = W.inherit({
        hitId: 0,
        trackHash: !1,
        ...
        _hitExt: function(a, b) {
            ...
            if (!h.isMetrikaPlayer()) {
                ...
                var m = {};
                a.nohit && c("nohit", 1);
                n.ar && !n.onlyData && (y = null === y || "" === y ? "" : this._prepareHitUrl(y),
                ...
                -1 != M().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ? c("ut", lb) : "undefined" != typeof n.ut && c("ut", h.trim(n.ut, hc));
                c("exp", a.experiments);
                ...
                f && (p = h.toJSON(f),
                this.trimParams && p.length > ic ? l = !0 : 7E5 < p ? h.warning("Too big params") : c("site-info", p));
        ...
        _getTechInfo: function(a, b, c, d, f, l, g, n, r, y) {
            ...
            u.isIframe() && (p("ifr", "1"),
            p("sti", u.isSameOriginTopFrame() ? "1" : "0"));
            ...
            r._firstPaint || y || (r._firstPaint = Yb(),
            p("fp", r._firstPaint));
            if (n) {
                g = E.get("winNameNum");
                if (!g) {
    ...
    v.getElementXY = function(a) {
        var b;
        if (!a || !a.ownerDocument || "PARAM" == a.tagName || a == v.getBody() || a == t.documentElement)
            return [0, 0];
        if (a.getBoundingClientRect) {
    ...
    v.getElementsByClassName = function(a, b) {
        ...
        for (c = 0; c < d.length; c++)
            v.classNameExists(d[c], a) && f.push(d[c]);
        return f
    }
    ;
    try {
                ...
                var d = function(a) {
                    ...
                    b.prototype.u = function() {
                        ...
                        try {
                            ...
                            h && (b.push("webgl unmasked vendor:" + a.getParameter(h.UNMASKED_VENDOR_WEBGL)),
                            b.push("webgl unmasked renderer:" + a.getParameter(h.UNMASKED_RENDERER_WEBGL)))
                        } catch (k) {}
            ...
            , function(a, b) {
                ...
                b.hash = function(a, b) {
                    ...
                    var l = (a = a || "").length % 16
                      ...
                      , q = [0, b];
                    b = [0, b];
                    for (var k, e, B = [2277735313, 289559509], H = [1291169091, 658871167], z = 0; z < r; z += 16)
    ...
    var nb = {
        ...
        addAsyncItem: function(a, b, c, d, f) {
            ...
            l.flushAsync(!0)) : x.getMs() - this.rest >= this.restTime && !this.timeout ? (this.rest = x.getMs(),
    ...
    try {
        ...
        , function(a, b, c) {
            ...
            a.exports = f;
            var r, m = c(0), p = m.LongBits, F = m.utf8, q, k = "undefined" != typeof Uint8Array ? function(a) {
            ...
            : k;
            f.prototype._slice = m.Array.prototype.subarray || m.Array.prototype.slice;
        ...
        , function(a, b, c) {
            ...
            a.exports = g;
            var F, q = c(0), k = q.LongBits, e = q.base64, B = q.utf8;
        ...
        , function(a, b, c) {
            ...
            d.prototype.rpcCall = function F(a, b, c, d, h) {
                ...
                var g = this;
                if (!h)
                    return f.asPromise(F, g, a, b, c, d);
                if (g.rpcImpl)
                    try {
          ...
          , mc = {
            ...
            toTransport: function(a, b, c, d) {
                ...
                if (c)
                    ...
                    return K[f].encode(this.nullToStr(a)).finish()
            },
            fromTrasport: function(a, b) {
                if ("number" == typeof a[0])
                    return K[b || "BufferWrapper"].decode(a)
            },
            serialize: function(a, b, c) {
                ...
                if (h)
                    d[a] = h.call(this, b),
                    f = new K.Wrapper(d);
                else if (c && K.Wrapper.prototype[a] !== A)
                    f[a] = b;
                else
        ...
        addData: function(a, b, c, d, f) {
            ...
            if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
                ...
                f) {
                    ...
                    this._data && 0 == this._data.buffer.length && (this.startBufferTime = x.getSeconds()),
    ...
    T.log = D(function() {
        ...
        m.console && console.log && this._check() && (T.enabled = !0,
    ...
    var C = {
      ...
      , cb = J.inherit({
        ...
        contentSizeWarning: function(a) {
            -1 === h.arrayIndexOf(this.alreadyWarned, a.id) && (T.log("Warning: content has only " + a.chars + " chars.Required " + Ea[a.type], a),
    ...
    var pb = cb.inherit({
        ...
        fields: {
            ...
            pageTitle: function(a) {
                ...
                "" === b && ((d = C.selectPropOne(c, "name")) || (d = C.selectPropOne(c, "itemReviewed")),
                d && (b += C.getVal(d)));
                3 === a.type && (a = C.closest(c, '[itemtype$\x3d"schema.org/Question"]')) && (d = C.selectPropOne(a, "text")) && (b += C.getVal(d));
                return b
            },
            authors: function(a) {
        ...
        _getContentData: function(a) {
            return a.element && a.element.innerText && a.element.innerText.length ? pb.superclass._getContentData.call(this, a) : null
        },
      ...
      , db = cb.inherit({
        ...
        _getContentNode: function(a) {
            ...
            return d ? d : C.closest(b, "head") || 0 === f.innerText.length ? m.document.body : f
        },
        _extractElementByHashedUrl: function(a) {
            var b, c;
            try {
                if (b = h.parseUrl(a).hash)
                    if (c = C.selectOne(t.body, b))
                        return c
            } catch (d) {
                return null
            }
        ...
        _getContentData: function(a) {
            ...
            if (!a.data && (a.data = aa.parse(b.innerText),
            !a.data || !/schema\.org/.test(a.data["@context"]) && !h.isArray(a.data)))
                return null;
      ...
      , Db = cb.inherit({
        ...
        _getContentData: function(a) {
            return (a = this._getEntityData(a)) ? Db.superclass._getContentData.call(this, a) : null
        }
    })
      , oc = J.inherit({
        buffer: null,
      ...
      , Eb = J.inherit({
        ...
        _initComponent: D(function() {
            ...
            "b" !== d && (this._formRecorder = new Sb(this.protocol,this.counterId,this.counterType,this.hid,this.globalConfig),
                ...
                if (d) {
                    ...
                    d.iterate ? h.forEachKey(f, function(a, d) {
                        ...
                        for (l = 0; l < h.length; l++)
                            this.executor.addAsyncItem(h[l].addData, h[l], f, [m, d, c, f, b], "send." + (d ? d.type || d.group || "" : "empty"))
      ...
      , Ib = J.inherit({
        ...
        hit: function(a, b) {
            ...
            f && f.params && f.time + l > x.getMs() ? (c.globalConfig.set("isEU", f.params.eu),
      ...
      , Jb = J.inherit({
        ...
        sync: function(a) {
            var b = this
              ...
              , d = c ? this._need(1) : !1;
            if (!c || u.isIframe() || u.isITPSafari())
                return a();
            this._is() ? a() : d ? (this._setStatus(!0),
        ...
        _need: function(a) {
            var b = this._getDomainByLang()
              , c = this._getTld()
              , d = [];
            1 === a && ((a = this.syncTlds[c]) && d.push.apply(d, a),
            a = this.syncTlds[b],
    ...
    var qc = function(a, b) {
      ...
      , rc = function(a, b) {
        0 === parseFloat(a.c_recp) && (Kb(b),
        b.s.set("ymoo" + b.k, x.getMinutes()))
    }
      , sc = function(a) {
        var b = x.getMinutes(), c;
    ...
    var Sa = {
      ...
      , uc = {
        ...
        _enabled: function(a, b, c) {
            var d = .1 >= Math.random();
            if (!(60 < x.getMinutes() - Sa.getNum("ds")) || this._is() || h.isDev(this.globalConfig))
                return !1;
            0 === b && 67993306 === a && (d = 1);
        ...
        getTarget: function(a) {
            ...
            try {
                if (b = a.target || a.srcElement)
                    !b.ownerDocument && b.documentElement ? b = b.documentElement : b.ownerDocument !== t && (b = null)
            } catch (c) {}
            return b
        },
    ...
    u.isSearchRobot = h.memorize(function() {
        return (new RegExp("(" + "yandex.com/bots|Googlebot|APIs-Google|Mediapartners-Google|AdsBot-Google|FeedFetcher-Google|Google-Read-Aloud|DuplexWeb-Google|Google Favicon|googleweblight|Mail.RU_Bot|StackRambler|Slurp|msnbot|bingbot|www.baidu.com/search/spi_?der.htm".replace(/[./]/g, "\\$\x26") + ")")).test(m.navigator.userAgent)
    });
    var Ia = J.inherit({
        counter: null,
        prefsEcommerce: null,
    ...
    var xa = ["0", "1", "2", "3"]
      ...
      , wc = ["https://brozen.yandex.ru", "https://yabro1.zen-test.yandex.ru/yabro/index.html", "https://yabro2.zen-test.yandex.ru/yabro/index.html"]
      , la = J.inherit({
        globalKey: "f1",
        MAX_SIZE: 1E6,
        isYAN: !1,
        ...
        handleGdprValue: function(a, b, c) {
            ...
            if (a || l || d.enabled)
                if (f.create("gdpr_popup", Lb),
                d.frameConnector && d.frameConnector.addHandler("isYandex", function() {
                    return {
                        type: "isYandex",
                        isYandex: pa()
                    }
                ...
                d.frameConnector.isIframe) {
                    d.frameConnector.sendToParents({
                        ...
                        var g = !1;
                        clearTimeout(r);
                        c[0].isYandex ? (d.trigger("GDPR-frame-ya"),
                        h.map(function(a) {
                            d.frameConnector.addHandler(a, function() {
                                var h = d.parseValue(a);
                                g || (h && (d.setGdprCookie(f, h),
                                d.realise(c, b)),
                                g = !0)
                            })
                        }, d.getPopupOkEvents())) : (d.trigger("GDPR-frame-noya"),
                        d.realise(c, b))
                    });
                ...
                return a || (f.create("gdpr", "0"),
                d.trigger("GDPR-eu-skip")),
                d.realise(c, b)
        },
        handle: function() {
            var a = this._sender
            ...
            if (!this.enabled && (h.inArray(xa, d) || u.isSafariWebView() || u.isAndroidWebView() || h.inArray(wc, m.location.href.split("?")[0]) || !pa() || c.read("yandex_login") || this.disable || n))
                return c.read("yandex_login") ? (this.trigger("GDPR-skip-login"),
                c.create("gdpr", "0", 525600)) : pa() ? d ? d === Lb ? this.trigger("GDPR-cookie-fail") : this.trigger("GDPR-cookie-success") : u.isSafariWebView() || u.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : n ? this.trigger("28") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"),
                this.realise(g, b);
    ...
    var xc = {
        init: function(a, b, c) {
            "22663942" == c && (c = t.createElement("img"),
    ...
    v.getElementPath = function(a) {
        for (var b = "", c = fc(); a && a.parentNode && "BODY" != a.tagName && "HTML" != a.tagName; )
            b += c[a.tagName] || "*",
    ...
    var yc = W.inherit({
      ...
      , zc = J.inherit({
        ...
        start: function() {
            if (!this._start)
                w.on(t, "click", this._handler, this);
            this._start = !0
        },
        stop: function() {
      ...
      , Nb = J.inherit({
        ...
        checkAssessor: function() {
            ...
            h.forEachKey(b, function(c) {
                if ((new RegExp(c)).test(m.location.hash) || N.get(this.ASSESSOR_COOKIE + c))
                    N.set(this.ASSESSOR_COOKIE + c),
                    a.push(b[c])
            }, this);
            return a
        },
        ...
        _onMessage: function(a) {
            ...
            d && this._isAllowedOrigin(d) && (d = aa.parse(a.data)) && "appendremote" === d.action && !this._executedMsgs[d.id] && this._isAllowedResource(d.resource) && (d.inline ? c = d.resource : b = d.resource,
            b && (this._executedMsgs[d.id] = !0,
            m._ym__postMessageEvent = a,
            m._ym__inpageMode = d.inpageMode,
            m._ym__initMessage = d.initMessage,
            this._buildRemoteIframe(b)),
            c && (this._executedMsgs[d.id] = !0,
            v.loadScript({
                src: c
            }, m)))
        }
            ...
            this.enabled() && w.ready(function() {
                ...
                var d = function(a) {
                    if (a.data && a.data.split) {
                        ...
                        "sc.frame" === d[0] && c ? (c = !1,
                        h.clearTimeout(l),
                        a.source.postMessage("sc.images*" + b.join("*"), "*")) : "sc.image" === d[0] && 1 < d.length && d[1] && (b = h.arrayFilter(b, function(a) {
                            return a !== d[1]
                        }, null),
                        b.length || (Sa.save("cm", x.getMinutes()),
                        f()))
                    }
                };
                var f = function() {
    ...
    var Bc = {
      ...
      , Ja = J.inherit({
        ...
        onClick: D(function(a) {
            ...
            var b = this, c;
            "submit" === (a && a.type) && (c = v.closest(a, "form")) && (this.awaitSubmitForms.push(c),
            h.setTimeout(D(function() {
    ...
    var L = M(), hb = x.getTimezone(), ib = x.getTimestamp(), ea = m.screen, hc = 64, mb = u.isIE() ? 512 : 2048, ic = u.isIE() ? 512 : 2048, Ab = u.isIE() ? 100 : 400, Hb = 100, lb = "noindex", Rb = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i, Cc = +new Date, ka = "Metrika", rb, eb, ya = "1976";
        ...
        return D(function() {
            function l(a, b, c) {
                ...
                if (a) {
                        ...
                        if (d && d.length)
                            for (e = 0; e < d.length; e++) {
                                ...
                                if ("ref" == f.type)
                                    ...
                                    var sa = t.referrer, Ha = wa.parse(L.search), v = y(L.search, L.hash), u;
                                    var w = Ha;
                                    var x = {};
                    ...
                    d && a ? (b.create("mp2_substs", h.toJSON(a)),
                    a = n(a),
                    c.params("__ym", a ? "mp_trackid" : "mp_trackid_bad", d)) : r()
                } else
                    r()
            }
            function g(a) {
                ...
                if (a && "string" != typeof a && a.length)
                    for (d = 0; d < a.length; d++) {
                        ...
                        if ("#" == g) {
                            ...
                            for (g = v.getElementsByClassName(e),
                            e = 0; e < g.length; e++) {
                                c = !0;
                                var h = g[e]
                                  , k = f;
            ...
            function C() {
                ...
                Da.userInfo = W._userID,
                zb.init(E));
                Da.initPU(ia, E);
                u.isAndroidWebView() || Da.initPP(E);
                W.retransmit(E);
                na && xc.init(na, Q, a);
                E.get("pri") != A || u.isAndroidWebView() || (E.setSafe("pri", null),
                u.isPrivate(D(function(a) {
                    E.set("pri", a)
                }, "privCb")));
                if (E.get("hitParam")[V]) {
                    if (1 != c || E.get("counters")[V])
                        return !1;
                    g = !0
                }
                E.get("counters")[V] = f;
                    ...
                    var p = function(e) {
                        ...
                        g.sendHit({
                            ...
                            callback: function(g, k) {
                                ...
                                f.isDestructing() || (ma.start(g.webvisor, g.publisher),
                                l(g.mp2, a, f),
                ...
                0 != h.keys(G).length && (da && da.initUserLayer(),
                G.enableAll ? (k(!0),
                B(!0),
                z()) : (G.clickmap && B(G.clickmap),
                G.trackLinks && k(G.trackLinks),
                G.accurateTrackBounce && z(G.accurateTrackBounce)),
                G.triggerEvent && h.async(function() {
                ...
                if (f._trackLinks && f._trackLinks.on) {
                    ...
                    if (c && !v.classNameExists(a, "ym-disable-tracklink")) {
                        ...
                        if (v.classNameExists(a, "ym-external-link"))
                            ...
                            xa.set("pai", d.pai),
                            g && g !== c && xa.set("il", h.trim(g, Hb))) : c && -1 !== c.search(/^ *(data|javascript):/i) || (d.ut = lb,
                            R.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
            ...
            function H(a, b) {
                ...
                function e(a) {
                    ...
                    for (b = 0; b < r.length; b += 3)
                        if (a)
                            w.on(r[b], r[b + 1], r[b + 2], {
                                name: "tabTrack"
                            });
                        else
                            w.un(r[b], r[b + 1], r[b + 2])
                }
                var f = !1
                  , g = !1
                  , k = !0
            ...
            function z(b) {
                ...
                if (!f._isAccurateTrackBounce) {
                    ...
                    ((e = e.get("lastHit")) && (!g || g < e - 18E5) || !Vb(c, d) || .1 > Math.random()) && H(function() {
                        f.notBounce();
                        Ea.init(.002, ra)
                    }, b)
                }
            ...
            function I(a) {
                if (!1 === a)
                    O && ("onhashchange"in m ? w.un(m, "hashchange", K) : h.clearTimeout(ya),
                    O = !1);
                else if (a = K,
                !O) {
            ...
            var ka = "", G = {}, ba = "", ua = $a.lastReferrer = L.href, ra = .002, pa = !1, ma;
            E.setSafe("counter", f);
            Pa && D(function() {
                throw Pa.error;
            }, "include." + Pa.scope)();
            ...
            if (!m["disableYaCounter" + a]) {
                ...
                var V = a + ":" + c;
                if (E.get("counters")[V])
                    return T.log("Duplicate counter " + V + " initialization"),
                    E.get("counters")[V];
                var Q = E.get("hitId");
                var ia = new Ob({
                    counterId: a,
                ...
                f.replacePhones = p(function() {
                    ...
                    try {
                        (b = (new N({
                            counterId: a
                        })).read("mp2_substs")) && (c = aa.parse(b)) && n(c, !0)
                    } catch (oa) {}
                    return f
                ...
                f.hit = p(function(b, c, d, e, g, k) {
                    ...
                    c = c.title),
                    P = b,
                    T.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", e),
                    R.sendHit({
                        url: b,
                        title: c,
                        hasPrerender: pa,
                ...
                if (a) {
                    ...
                    if ("prerender" === t.webkitVisibilityState || "prerender" === t.visibilityState) {
                        ...
                        var va = function() {
                            "prerender" !== t.webkitVisibilityState && "prerender" !== t.visibilityState && (w.un(t, "webkitvisibilitychange,visibilitychange", va),
                            q(!0))
                        };
